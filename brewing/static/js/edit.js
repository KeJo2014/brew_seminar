...
function addWater(waterName, waterAmount) {
    ++indexWater;
    ...
    inputWaterText.setAttribute('value', waterName);
    ...
    inputWaterNumber.setAttribute('value', waterAmount);
...
function addMaischphase(maltName) {
    ++indexPhase;
    indexRast.push(0);
